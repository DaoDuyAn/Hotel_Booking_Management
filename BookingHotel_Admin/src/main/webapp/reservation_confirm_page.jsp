	...
	<div id="layoutSidenav">
			...
			<nav class="sb-sidenav accordion sb-sidenav-dark"
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<a class="nav-link active" href="reservation_confirm_controller">
							<div class="sb-nav-link-icon">
		...
		<div id="layoutSidenav_content">
			...
			<div class="container-fluid px-4">
				<h1 class="mt-4">Room Reservation Confirm</h1>
								...
								<c:forEach var="item" items="${ds}">
									<tr>
										...
										<td class="text-center align-middle"><p
												class="text-success fw-semibold">${item.getStatus()}</p></td>
										<td class="text-center align-middle"><a
											class="btn btn-primary"
											href="reservation_confirm_controller?rdid=${item.getReserved_room_id()}&rvid=${item.getReservation_id()}">Confirm
