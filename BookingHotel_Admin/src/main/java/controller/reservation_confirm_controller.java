...
/**
 * Servlet implementation class reservation_confirm_controller
 */
@WebServlet("/reservation_confirm_controller")
public class reservation_confirm_controller extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public reservation_confirm_controller() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (rdid != null && rvid != null) {
				int updateRD = rdbo.updateStatusByRdId(Integer.parseInt(rdid), "Approval");
			...
			ArrayList<reserved_room_bean> ds = rdbo.getReservedConfirm("Pending approval");
			request.setAttribute("ds", ds);

			RequestDispatcher rd = request.getRequestDispatcher("reservation_confirm_page.jsp");
